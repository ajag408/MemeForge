  ...
  useEffect(() => {
    const fetchMemes = async () => {
      ...
      try {
        ...
        // Sort by combination of likes, remixes, and votes
        const sortedMemes = memesData.sort((a, b) => 
          (b.likes + b.remixes + b.votes) - (a.likes + a.remixes + a.votes)
        );

        setMemes(sortedMemes.slice(0, 6)); // Show top 6 featured memes
      } catch (error) {
